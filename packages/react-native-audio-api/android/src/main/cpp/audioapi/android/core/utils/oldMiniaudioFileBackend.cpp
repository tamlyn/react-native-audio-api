...
//   result = ma_encoder_init_file(filePath_.c_str(), &encoderConfig_,
//   &encoder_);
...
//   ma_result result =
//       ma_encoder_write_pcm_frames(&encoder_, data, numFrames,
//       &framesWritten);
...
//       &converter_, data, &inputFrameCount, converterOutput_,
//       &outputFrameCount);
