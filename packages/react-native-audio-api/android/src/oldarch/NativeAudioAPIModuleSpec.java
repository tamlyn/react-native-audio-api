...
public abstract class NativeAudioAPIModuleSpec extends ReactContextBaseJavaModule implements TurboModule {
  ...
  @ReactMethod
  @DoNotStrip
  public abstract void setRecordingLockScreenInfo(ReadableMap info);

  @ReactMethod
  @DoNotStrip
  public abstract void resetRecordingLockScreenInfo();

  @ReactMethod
  @DoNotStrip
  public abstract void setUiMode(String mode);
