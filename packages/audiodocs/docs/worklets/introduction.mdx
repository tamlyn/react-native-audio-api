...
```
> **Note**: Supported versions of `react-native-worklets` are [0.6.0, 0.6.1]. They are checked and updated manually with each release. Nightly versions are always supported but your build may fail.
