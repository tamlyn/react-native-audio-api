...
:::warning
To access microphone you need to make sure your app has met required conditions to do so. Refer to [permission section](/docs/fundamentals/getting-started#special-permissions) for more info.
:::
