...
For convenience we have provided set of most basic file configurations that should cover most of the cases (or at least we hope it will, please raise an issue if you find something lacking or misconfigured!).
