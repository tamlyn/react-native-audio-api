...
| Parameter | Type | Description |
| :---: | :---: | :---- |
| `numberOfOutputs` | `number` | The number of outputs. | <ReadOnly /> |

#### Errors

| Error type | Description |
| :---: | :---- |
| `IndexSizeError` | `numberOfOutputs` is outside the nominal range [1, 32]. |
...
| Parameter | Type | Description |
| :---: | :---: | :---- |
| `numberOfInputs` | `number` | The number of inputs. | <ReadOnly /> |

#### Errors

| Error type | Description |
| :---: | :---- |
| `IndexSizeError` | `numberOfInputs` is outside the nominal range [1, 32]. |
